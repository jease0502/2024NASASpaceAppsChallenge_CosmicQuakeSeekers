...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, GlobalAveragePooling1D, Dense, Dropout, Input, Softmax, Reshape, Add
...
# # # 建立堆疊的 CNN 模型
# def create_stacked_cnn_model(img_height, img_width):
